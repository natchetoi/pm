...
*/
    var data1=$('.field-type-slickgrid-field-slickgrid textarea').attr("value");
   if(data1==""){
...
//    $('#test2').attr('value',JSON.stringify(data));
  ...
  grid.onCellChange.subscribe(function (e, args) {
	...
	$(".field-type-slickgrid-field-slickgrid textarea").attr("value", JSON.stringify(dataView.getItems()));
  });
...
alert(o.toString());    
  ...
  $("#btnSelectRows").click(function () {
    ...
    var records={}
    for(i=0;i<=0;i++){
        //object2array(dataView.getItem(i));
	
    //    records.push(dataView.getItem(i));
    }
    //printObject(dataView.getItems());
    
    //alert(dataView.getLength());
    alert(JSON.stringify(dataView.getItems()));
//    printObject(records);
